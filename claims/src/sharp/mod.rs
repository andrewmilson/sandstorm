...
pub struct CairoClaim<A: AirConfig<Fp = Fp, Fq = Fp>, T: CairoTrace<Fp = Fp, Fq = Fp>, D: Digest>(
    base::CairoClaim<Fp, A, T, D>,
);

impl<A: AirConfig<Fp = Fp, Fq = Fp>, T: CairoTrace<Fp = Fp, Fq = Fp>, D: Digest>
    CairoClaim<A, T, D>
{
...
impl<A: AirConfig<Fp = Fp, Fq = Fp>, T: CairoTrace<Fp = Fp, Fq = Fp>, D: Digest> Deref
