    ...
    A::Fp: PrimeField,
{
    ...
    async fn generate_proof(
        ...
        let mut channel = ProverChannel::<Self::AirConfig, Keccak256>::new(&air);
        ...
        let base_trace_lde_tree = base_trace_lde.commit_to_rows::<Keccak256>();
        ...
        let now = Instant::now();
        let mut fri_prover =
            FriProver::<Self::Fq, Keccak256>::new(air.options().into_fri_options());
